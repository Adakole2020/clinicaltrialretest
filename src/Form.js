...
export default function FormPage() {
    ...
    >>> > 8 a49209316db272fad56f2d1a6a77d47d6822695
    ...
    async function afterSubmit(values) {
        ...
        if (account && api) {
            try {
                ...
                await contract.tx.clearPreprocessed({})
                ...
                if (values.file_preprocessed) {
                    ...
                    try {
                        ...
                        NotificationManager.info(`received from blockchain: ${ParseFloat(p, 4)}`, "P-value on-chain", 5000);
                    } catch (e) {
                        console.log(e);
                    ...
                    try {
                        ...
                        let downloaded_csv = arrayToCSV(downloaded_preprocessed.output.toHuman());
...
return contract ? ( <
        ...
        RadioGroup value = { initialValues.testType }
        onChange = {
            (e) => setType(e.currentTarget.value) }
        name = "Test Type"
        align = { ALIGN.horizontal }
        label = "Choose the type of applied statistical test " >
        <
        ...
        type = "number"
        onChange = {
            (e) => setThreshold(e.currentTarget.value) }
        /> <
        /FormControl> <
        ButtonGroup align = { ALIGN.horizontal } >
        <
